...
namespace BlueBoxAutomation
{
    internal class ShaperMaxDefaultPage : TestBase
    {
        ...
        {
            string standbyModeShaper = ShaperLedOff.Text;
            string intervalTime = NoExecuteIntervalTime.Text;

            if (standbyModeShaper == "START" && intervalTime == "30")
            {
                Logger.Error("Shaper Standby Mode, LED indication - OFF");
                return true;
            }
        ...
        public string PassesControledByUser_Pluse(string area)
        {
            ...
            switch (area)
            {
                ...
                case "Thighs":
                    ...
                    pressingAmount = maxPassesValue - Convert.ToInt32(DefaultsPasses[4]);
                    ClickOnPassesPluse(pressingAmount);
                ...
                case "Knees":
                    ...
                    pressingAmount = maxPassesValue - Convert.ToInt32(DefaultsPasses[5]);
                    ClickOnPassesPluse(pressingAmount);
                ...
                case "Back":
                    ...
                    pressingAmount = maxPassesValue - Convert.ToInt32(DefaultsPasses[6]);
                    ClickOnPassesPluse(pressingAmount);

                    break;
            }

            int actualMaxValue = Convert.ToInt32(ShaperPassesMaximumValue.Text);
        ...
        public string PassesControledByUser_Minus()
        {
            ...
            int actualMinValue = Convert.ToInt32(ShaperPassesMinimumValue.Text);
        ...
        public string PowerControledByUser_Pluse()
        {
            ...
            int actualMaxValue = Convert.ToInt32(ShaperPowerMaximumValue.Text);
        ...
        public string PowerControledByUser_Minus()
        {
            ...
            int actualMaxValue = Convert.ToInt32(ShaperPowerMinimumValue.Text);
        ...
        {
            bool isShaperSelected = WaitUntil(() => ShaperLabel.Visible && FlanksShaper.Enabled, 10000, "Shaper body treatment area is not open");

            if (isShaperSelected)
                return "ShaperMax page is enterd properly";

            Logger.Error("Shaper area not displayed");
            return "Shaper area not enterd";
        }
    }
}
